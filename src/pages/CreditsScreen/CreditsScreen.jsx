      ...
      <div className="creditsScreen-content"> 
        ...
        <h2 className="creditsScreen-text">Image credits</h2>
          <li><a className="creditsScreen-pictureCredit"
                href="https://www.flickr.com/photos/57511216@N04/11122576535"
                target="_blank"
                rel="noopener noreferrer">
          Ibrox by daniel0685</a> on <a href="https://creativecommons.org/licenses/by/2.0/">Creative Commons 2.0 Licence</a>.
          </li>
          <li><a className="creditsScreen-pictureCredit"
